  ...
  return (
    <div className="page__body" id="page__404body">
      <div id="projects_page__grid">
        ...
        <ProjectCard title={"Racism Satire Text-Based Game"} description={"Built text-based, LLM-powered game to critique Orientalism for Asian American Studies department at Northwestern; played by seminar class of 15 students."} tags={"react, openai, flask"} github={"https://github.com/andrlime/porygon/tree/main/sunflora"} />
