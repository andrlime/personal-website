  ...
  return (
    <div className="page__body">
      ...
      <div id="projects_page__grid">
        ...
        <ProjectCard title={"Q Learning Snake in Julia"} description={"Built Q Learning snake using GameZero.jl without using external libraries."} year={"2022"} tags={"julia"} />
